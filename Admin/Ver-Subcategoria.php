		...
		<div class="col-sm-9">
			...
			<form method="post">
				<table border="0" width="400px" height="300px" align="center" class="tableshadow">
						<tr><td class="toptd">Ver subcategorias</td></tr>
						<tr><td align="center" valign="top" style="padding-top:10px;">
							<table border="0" align="center" width="80%" >
								<tr><td style="font-size:15px; padding:5px; font-weight:bold;">Id subcategoria</td>
								<td style="font-size:15px; padding:5px; font-weight:bold;">Nombre subcategoria</td></tr>
